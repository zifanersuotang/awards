# JSP-000616 / Erdős 748: attributed existing proof verification

The base-two logarithm of the number of sum-free subsets of [1,n], divided by n, tends to 1/2. This is exactly the requested 2^((1+o(1))*n/2) rate.

Scope boundary: No claim is made here that the stronger parity-dependent constant asymptotic from the bibliography is formalized.

The [pinned original source](https://github.com/plby/lean-proofs/blob/8822f7ddef30fadbd92e1c6ab4ed897af356af5e/src/latest/ErdosProblems/Erdos748.lean) and its complete local import closure are copied without edits. Main-file mathematical credits: Ben Green, Alexander Sapozhenko. Main-file formal credits: Codex, GPT-5.6 Sol. Imported proof files retain their own credit and license notices. This packet makes no claim of a new mathematical result or new formal proof authorship by the submitting account.
...
[Original question](https://www.erdosproblems.com/748) · [Catalog entry](https://github.com/TheJustinSunPrize/awards/blob/main/problems/catalog-0601-0700.md#JSP-000616). statement-review.md records the reviewed definitions, quantifiers and limitations.
