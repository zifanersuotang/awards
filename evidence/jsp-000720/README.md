# JSP-000720 / Erdős 869: attributed existing proof verification

Constructs two disjoint asymptotic additive bases of order two whose union contains no minimal subbasis. Every basis contained in that union remains a basis after any one-element deletion. A recursive certificate is actually constructed; the final theorem is unconditional.

Scope boundary: No stronger result is inferred.

The [pinned original source](https://github.com/plby/lean-proofs/blob/8822f7ddef30fadbd92e1c6ab4ed897af356af5e/src/latest/ErdosProblems/Erdos869.lean) and its complete local import closure are copied without edits. Main-file mathematical credits: Daniel Larsen. Main-file formal credits: Codex, GPT-5.6 Sol. Imported proof files retain their own credit and license notices. This packet makes no claim of a new mathematical result or new formal proof authorship by the submitting account.
...
[Original question](https://www.erdosproblems.com/869) · [Catalog entry](https://github.com/TheJustinSunPrize/awards/blob/main/problems/catalog-0701-0800.md#JSP-000720). statement-review.md records the reviewed definitions, quantifiers and limitations.
