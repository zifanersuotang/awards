# JSP-000711 / Erdős 858: attributed existing proof verification

Exact finite extremal reciprocal mass over subsets [1,N] with no proper multiplicative pair b=a*t, t>1, minFac(t)>a; divided by log N tends to explicitly defined constant. t>1 avoids self-pair artifact.

Scope boundary: No stronger result is inferred.

The [pinned original source](https://github.com/plby/lean-proofs/blob/8822f7ddef30fadbd92e1c6ab4ed897af356af5e/src/latest/ErdosProblems/Erdos858.lean) and its complete local import closure are copied without edits. Main-file mathematical credits: Przemek Chojecki, GPT-5.4 Pro. Main-file formal credits: Codex, GPT-5.6 Sol. Imported proof files retain their own credit and license notices. This packet makes no claim of a new mathematical result or new formal proof authorship by the submitting account.
...
[Original question](https://www.erdosproblems.com/858) · [Catalog entry](https://github.com/TheJustinSunPrize/awards/blob/main/problems/catalog-0701-0800.md#JSP-000711). statement-review.md records the reviewed definitions, quantifiers and limitations.
