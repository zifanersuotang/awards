# JSP-000605 / Erdős 737: attributed existing proof verification

An edge of an uncountably chromatic graph lies in cycles of every sufficiently large length. Public theorem assumes exact aleph-one chromatic number; its proved helper eventually_cycles_through_fixed_edge only assumes no countable coloring and covers the catalog wording.

Scope boundary: No stronger result is inferred.

The [pinned original source](https://github.com/plby/lean-proofs/blob/8822f7ddef30fadbd92e1c6ab4ed897af356af5e/src/latest/ErdosProblems/Erdos737.lean) and its complete local import closure are copied without edits. Main-file mathematical credits: Carsten Thomassen. Main-file formal credits: Codex, GPT-5.6 Sol. Imported proof files retain their own credit and license notices. This packet makes no claim of a new mathematical result or new formal proof authorship by the submitting account.
...
[Original question](https://www.erdosproblems.com/737) · [Catalog entry](https://github.com/TheJustinSunPrize/awards/blob/main/problems/catalog-0601-0700.md#JSP-000605). statement-review.md records the reviewed definitions, quantifiers and limitations.
