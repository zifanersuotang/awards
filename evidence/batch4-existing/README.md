...
This directory contains actual local verification metadata and logs for 14 existing public formalizations. The official registration is [Issue 24](https://github.com/TheJustinSunPrize/awards/issues/24); a successful local result does not establish official acceptance.
