# JSP-000620 / Erdős 754: attributed existing proof verification

The extremal minimum favorite-distance degree among n-point subsets of real four-dimensional Euclidean space is <=n/2+202. Distances are separately chosen positive values at each point and other points are counted.

Scope boundary: No stronger result is inferred.

The [pinned original source](https://github.com/plby/lean-proofs/blob/8822f7ddef30fadbd92e1c6ab4ed897af356af5e/src/latest/ErdosProblems/Erdos754.lean) and its complete local import closure are copied without edits. Main-file mathematical credits: Konrad J. Swanepoel. Main-file formal credits: Codex, GPT-5.6 Sol. Imported proof files retain their own credit and license notices. This packet makes no claim of a new mathematical result or new formal proof authorship by the submitting account.
...
[Original question](https://www.erdosproblems.com/754) · [Catalog entry](https://github.com/TheJustinSunPrize/awards/blob/main/problems/catalog-0601-0700.md#JSP-000620). statement-review.md records the reviewed definitions, quantifiers and limitations.
